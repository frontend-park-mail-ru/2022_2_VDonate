...
// import {NavbarUnit, OrientType} from '@components/navbar-lable/navbar_unit';
...
//     });
//     const change =
// new Button(ButtonType.outline, 'Изменить данные', 'button');
...
//       const avatar = new Image(ImageType.author, subItem.authorAvatar ?? '');
